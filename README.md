...
* [DynamoDB Examples](https://github.com/aws-samples/aws-dynamodb-examples) ⭐ 603 | 🐛 25 | 🌐 TypeScript | 📅 2026-09-10 - An Amazon Web Services and DynamoDB community lead repository containing code and examples for developing with and using Amazon DynamoDB.
...
* [Alternator](https://github.com/scylladb/scylla/blob/master/docs/alternator/alternator.md) ⭐ 15,766 | 🐛 3,681 | 🌐 C++ | 📅 2026-09-18 - a Scylla feature adding compatibility with Amazon DynamoDB. It can be used [locally with Docker](https://hub.docker.com/r/scylladb/scylla/) or in production.
...
* [typesafe-dynamodb](https://github.com/sam-goodwin/typesafe-dynamodb) ⭐ 219 | 🐛 2 | 🌐 TypeScript | 📅 2026-09-18 - Provides type safety and editor type hints to the `getItem`, `putItem`, `deleteItem` and `query` API (SDK v2) calls which understand the structure of data in your table.
* [dynamodb-shell](https://github.com/awslabs/dynamodb-shell) ⭐ 166 | 🐛 2 | 🌐 C++ | 📅 2026-09-15 - A simple CLI for DynamoDB modeled on isql and the MySQL CLIs. a simple CLI for DynamoDB modeled on isql, and the MySQL CLIs.
...
* [DynamoSharp](https://github.com/ChrixApp/DynamoSharp) ⭐ 6 | 🐛 0 | 🌐 C# | 📅 2026-09-18 - An ORM for C# with a focus on single-table design.
...
* [Dynamo Mapper](https://github.com/autonomouslogic/dynamo-mapper) ⭐ 3 | 🐛 4 | 🌐 Java | 📅 2026-09-16 - A simple mapper for converting to and from DynamoDB AttributeValues and Java POJOs using Jackson.
